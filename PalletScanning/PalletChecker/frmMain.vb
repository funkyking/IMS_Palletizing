...
Public Class frmMain
    ...
    Private Sub frmMain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If username.ToString().Contains("admin") Then
            GlobalVariables.AdminAccess = True
        Else
            GlobalVariables.AdminAccess = False
        End If
    ...
    Function ShowMDIForm(frm As Form) As Boolean
        ...
        Try
            ...
            frm.Anchor = AnchorStyles.Left And AnchorStyles.Top And AnchorStyles.Right And AnchorStyles.Bottom
            frm.Show()
            frm.BringToFront()
    ...
    Private Sub frmMain_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        Try
            Closeform()
            If Not GlobalVariables.LoginInstance Is Nothing Then
                GlobalVariables.LoginInstance.Dispose()
            End If
        Catch ex As Exception
        End Try
    End Sub
