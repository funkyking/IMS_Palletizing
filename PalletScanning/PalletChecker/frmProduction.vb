	...
	Private Function reprint()
		...
		For i = 1 To PalletBox.Text
			...
			If Conn.State = ConnectionState.Open Then
				Dim SQLcmd = New SqlCommand
				SQLcmd.Connection = Conn
				SQLcmd.CommandText = "SELECT DISTINCT p.[Serial No],w.[Sub Group],p.[Work Order ID],p.[Index],p.[Carton]
										FROM [CRICUT].[CUPID].[WorkOrder] p   
										INNER JOIN [CRICUT].[CUPID].[WorkOrderMaster] w
										ON p.[Work Order ID]=w.[Work Order ID]   
				...
				If ds.HasRows Then
					...
					'If Carton has no Value we use our Loop Incrementation
					While ds.Read
						...
						If cnt <= 40 Then
							...
							'If SkipCarton = 0 Then
							'End If
							If ds.Item("Carton") = Nothing Or ds.Item("Carton") = "" Then
								c1.Cells(i1, 2).Value = Carton_Index.ToString("0000")
							Else
								c1.Cells(i1, 2).Value = ds.Item("Carton")
							End If
							i1 += 1
						...
						ElseIf cnt > 40 And cnt <= 80 Then
							...
							'End If
							If ds.Item("Carton") = Nothing Or ds.Item("Carton") = "" Then
								c2.Cells(i2, 2).Value = Carton_Index.ToString("0000")
							Else
								c2.Cells(i2, 2).Value = ds.Item("Carton")
							End If
							i2 += 1
						...
						ElseIf cnt > 80 And cnt <= 120 Then
							...
							'End If
							If ds.Item("Carton") = Nothing Or ds.Item("Carton") = "" Then
								c3.Cells(i3, 2).Value = Carton_Index.ToString("0000")
							Else
								c3.Cells(i3, 2).Value = ds.Item("Carton")
							End If
							i3 += 1
